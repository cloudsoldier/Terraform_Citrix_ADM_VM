...
data "azurerm_key_vault_secret" "ADCvmpassword" {
  name         = "ADCvmpassword"
...
<<<<<<< HEAD
    admin_password = data.azurerm_key_vault_secret.ADCvmpassword.value
=======
    admin_password   = data.azurerm_key_vault_secret.adccorefinder.value
>>>>>>> pt3-2895
